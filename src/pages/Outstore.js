      ...
      <Container class1="store-wrapper py-5 home-wrapper-2">
          <div className="row">
            <div className="col-3">
              <div className="filter-card mb-3">
                <h3 className="filter-title">Shop By Cateqories</h3>
                <div>
                  <ul>
                    <li>Watches</li>
                    <li>Camera</li>
                ...
                <div>
                  ...
                  <div className="d-flex align-items-center gap-10">
                    ...
                    <form className="form-floating mb-3">
                      ...
                      />
                      <label htmlFor="floatingInputValue1">
                        To
                      </label>
                    </form>
                  </div>
              ...
              <div className="filter-card mb-3">
                ...
                <div>
                  <div className="product-tags d-flex flex-wrap align-items-center gap-10">
                    ...
                    <span className="badge bg-light text-secondary rounded-3 py-2 px-3">Ipads</span>
                    <span className="badge bg-light text-secondary rounded-3 py-2 px-3">Smart Watch</span>
                    <span className="badge bg-light text-secondary rounded-3 py-2 px-3">Smart gadets</span>
                    <span className="badge bg-light text-secondary rounded-3 py-2 px-3">Chargers</span>
                  </div>
                </div>
              </div>
              <div className="filter-card mb-3">
                  ...
                  <div className="random-products mb-3 d-flex ">
                    ...
                    <div className="w-50">
                      <h5>Kids headphones bulk 10pack multi colored for students</h5>
                       <ReactStars count={5} size={24}  edit={ true } activeColor="#ffd700" />
                      <b>Rs4,000/- only</b>
                    </div>
                  </div>
          ...
          <div className="col-9">
           ...
           <div className="product-list pb-5">
            <div className="pavan gap-10 d-flex flex-wrap">
